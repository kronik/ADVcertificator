...
@interface NSData(ADVNSDataExtension)

-(BOOL)isEqualToByteArray:(const Byte *)byteArray length:(NSUInteger)byteArrayLength;

@end


@interface NSMutableData(ADVNSDataExtension)
